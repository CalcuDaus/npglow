...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create') {
        ...
        header("Location: admin_products.php?msg=created");
        exit();
    ...
    <header class="bg-[#3ca6f2] text-white p-4 flex justify-between items-center shadow-md z-10">
        <div class="flex items-center gap-8">
            ...
            <nav class="hidden md:flex gap-2">
                <a href="admin.php" class="hover:bg-white/20 px-4 py-2 rounded-lg text-sm font-medium transition">Konsultasi</a>
                <a href="admin_products.php" class="bg-white/20 px-4 py-2 rounded-lg text-sm font-medium transition">Katalog Produk</a>
            </nav>
        </div>
