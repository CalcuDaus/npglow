                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-5 flex items-start gap-4" id="rp-<?= $rp['id'] ?>">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <button onclick="editProduct(<?= $rp['id'] ?>, <?= $rp['custom_price'] !== null ? $rp['custom_price'] : 'null' ?>, <?= $rp['stock'] ?>, <?= $rp['minimum_price'] ?? $rp['base_price'] ?>)" class="inline-flex items-center gap-1.5 text-xs font-bold text-blue-600 hover:text-blue-800 px-2.5 py-1.5 rounded-lg hover:bg-blue-50 transition">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                    Edit
                                </button>
                                <button onclick="toggleProduct(<?= $rp['id'] ?>)" class="inline-flex items-center gap-1.5 text-xs font-bold text-amber-600 hover:text-amber-800 px-2.5 py-1.5 rounded-lg hover:bg-amber-50 transition">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636a9 9 0 11-12.728 0M12 3v9"></path></svg>
                                    <?= $rp['is_available'] ? 'Nonaktifkan' : 'Aktifkan' ?>
                                </button>
                                <button onclick="removeProduct(<?= $rp['id'] ?>)" class="inline-flex items-center gap-1.5 text-xs font-bold text-red-500 hover:text-red-700 px-2.5 py-1.5 rounded-lg hover:bg-red-50 transition">
