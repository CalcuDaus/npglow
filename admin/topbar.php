<?php
// Minimal Admin Topbar for Mobile Header & Desktop Breadcrumbs
if (!isset($pageTitle)) {
    $currentScript = basename($_SERVER['PHP_SELF']);
    $pageTitle = match($currentScript) {
        'orders.php' => 'Manajemen Pesanan Masuk',
        'payments.php' => 'Metode Pembayaran',
        'products.php' => 'Katalog Produk',
        'photos.php' => 'Bank Data Foto',
        default => 'Dashboard Ringkasan'
    };
}
?>
<header class="bg-white border-b border-gray-200/80 sticky top-0 z-30 px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between shadow-sm">
    ...
    <div class="flex items-center gap-3">
        ...
        <button onclick="toggleAdminSidebar()" class="lg:hidden p-2 rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition border border-gray-200 focus:outline-none">
