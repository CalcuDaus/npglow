...
// For normal user: user_id is their own id. For expert: user_id is the target user they are chatting with.
$is_expert = isset($_SESSION['role']) && $_SESSION['role'] === 'expert';
$user_id = $is_expert && isset($_GET['target_user_id']) ? (int)$_GET['target_user_id'] : $_SESSION['user_id'];
